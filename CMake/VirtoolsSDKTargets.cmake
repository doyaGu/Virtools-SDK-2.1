...
foreach(_expectedTarget CK2 VxMath)
...
foreach(name IN ITEMS CK2 VxMath)
	...
	set_target_properties(${name} PROPERTIES
		...
		IMPORTED_LOCATION "${_IMPORT_PREFIX}/Lib/${name}.lib"
	)
	...
	list(APPEND _IMPORT_CHECK_TARGETS ${name})
	list(APPEND _IMPORT_CHECK_FILES_FOR_${name} "${_IMPORT_PREFIX}/Lib/${name}.lib")
endforeach()
